...
Fields.Select = React.createClass({displayName: "Select",
	...
	render: function() {
		...
		if(!optionsError) {
			displaySelect = (
				React.createElement("select", {className: "form-control", onChange: this.onSelectInputChange, defaultValue: "__default__"}, 
					defaultOption, 
					options, 
...
Fields.MultiSelect = React.createClass({displayName: "MultiSelect",
	...
	render: function() {
		...
		if(!optionsError) {
			displaySelect = (
				React.createElement("select", {className: "form-control", onChange: this.onSelectInputChange, multiple: true}, 
					options
				)
			);
		} else {
