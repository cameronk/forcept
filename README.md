...
- DB_USERNAME: MySQL user used to connect to the above database (Default: `forcept`)
...
As of v1.0.0-beta, the `count` property does nothing other than display the `count` specified within the medication list - it doesn't update when a medicine is given out. (_this is coming soon_).
